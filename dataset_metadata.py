...
class DatasetMetadata:
    ...
    def get_file_path(self, ext):
        return self.h5_file_path.with_suffix(ext)


def new_dataset_metadata(measurement=None, fname=None):
    ...
    path = Path(app.settings["save_dir"])
    return DatasetMetadata(unique_id, u, t0, path / fname)
