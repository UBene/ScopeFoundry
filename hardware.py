...
class HardwareComponent:
    ...
    def New_UI(self, include=None, exclude=None, style="scroll_form", exclude_ops=None):
        # maybe not needed as new_control_widgets does effectively the same
        return self.settings.New_UI(include, exclude, style, self.operations)

    def new_control_widgets(self):
        return new_control_widgets(self.name, self.settings, self.operations)
